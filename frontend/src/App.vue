  ...
  <div v-bind:class="{ 'dark': theme.isDark }">
    <div class="min-h-screen dark:bg-black dark:text-white">
      <router-view
        ...
        :qualifier="qualifier"
      />
      <div  class="absolute h-8 pb-2 w-full text-center text-xs dark:bg-black dark:text-white">
        <a href="https://reposilite.com/" target="_blank">Frontend from Reposilite</a>
      </div>
    </div>
  </div>
</template>
